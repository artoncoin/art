...
window.onload = function () {
    ...
    // Swal.fire(
    //     'Important notice',
    //     'Cryptocurrency may be unregulated in your jurisdiction. The value of cryptocurrencies may go down as well as up. Profits may be subject to capital gains or other taxes applicable in your jurisdiction. but with my Cryptocurrency $ART holders can always gain from my token and this amazing one of kind ART.',
    //     'question'
    // );
    buildArray();
    bly_animate();
